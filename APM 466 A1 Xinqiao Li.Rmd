...
while(t <= 10){
  ...
  r_1 = -log(data[[paste("DP",toString(t),sep="")]][1] /(0.5*100*data$Coupon[1]+                                                     100))/((60-date[t])/365)
  r = c(r_1)
  
  # calculate r_2 for bond2 with maturity 6/1/2022
  r_2 = -log(data[[paste("DP",toString(t),sep="")]][2] /(0.5*100*data$Coupon[2]+                                                     100))/((152-date[t])/365)
